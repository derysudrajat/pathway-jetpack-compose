...
fun SelectableIconButton(
    ...
    val tint = if (isSelected) MaterialTheme.colors.primary
...
@Composable
fun TodoInputTextPreview() {
    TodoInputText(text = "", onTextChange = {}, modifier = Modifier.padding(end = 8.dp))
}
